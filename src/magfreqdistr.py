...
def sample_GRdistr(bvalue, avalue, Mmin, Mmax,nevents = 1, mbin=0.1, rseed=None):
    mags = np.arange(Mmin, Mmax, mbin)
...
def test_sample_GRdistr(bvalue, avalue, Mmin, Mmax, nevents=10000, rseed=None):
    ...
    eN, emag = distr_empirical(samp_mag, minimum_mag=4.0, doplot=True);
